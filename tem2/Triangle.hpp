...
public:
	Triangle(Eigen::Vector3f e1, Eigen::Vector3f e2){
		edge1 = e1;
		edge2 = e2; 
	...
	void sample(Intersection& inter, float& pdf) {
		...
		inter.pos = vertex[0] * (1 - rand1 - rand2) + vertex[1] * rand1 + vertex[2] * rand2;
		inter.normal = normal[0] * (1 - rand1 - rand2) + normal[1] * rand1 + normal[2] * rand2;
	}
private:
	Material* material;
